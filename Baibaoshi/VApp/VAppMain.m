...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _arrowIcon.tintColor = [UIColor systemBlueColor];
...
- (void)handlePan:(UIPanGestureRecognizer *)g {
    ...
    if (g.state == UIGestureRecognizerStateChanged) {
        ...
        else _arrowIcon.tintColor = [UIColor systemBlueColor];
        ...
        if (x > maxX * 0.82) {
            ...
            [UIView animateWithDuration:0.25 animations:^{
                ...
                _trackView.backgroundColor = [UIColor systemGreenColor];
                _tipLabel.alpha = 0;
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _rightLabel.textColor = [UIColor systemGrayColor];
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _pctLabel.textColor = [UIColor systemGreenColor];
...
- (void)setPct:(double)pct {
    ...
    if (p >= 90) {
        _bar.progressTintColor = [UIColor systemRedColor];
        _pctLabel.textColor = [UIColor systemRedColor];
    } else if (p >= 75) {
        _bar.progressTintColor = [UIColor systemOrangeColor];
        _pctLabel.textColor = [UIColor systemOrangeColor];
    } else {
        _bar.progressTintColor = [UIColor systemGreenColor];
        _pctLabel.textColor = [UIColor systemGreenColor];
    }
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _snapBtn.layer.borderColor = [UIColor systemBlueColor].CGColor;
        _snapBtn.layer.cornerRadius = 6;
        [_snapBtn setTitleColor:[UIColor systemBlueColor] forState:UIControlStateNormal];
        ...
        _autoBtn.layer.borderColor = [UIColor systemGrayColor].CGColor;
        [_autoBtn setTitleColor:[UIColor systemGrayColor] forState:UIControlStateNormal];
...
- (UIColor *)tempColor:(NSNumber *)temp {
    ...
    if (t > 60) return [UIColor systemRedColor];
    if (t >= 55) return [UIColor systemOrangeColor];
    return [UIColor systemGreenColor];
}

- (void)updateStatusDot:(BOOL)online {
    self.connected = online;
    self.statusDot.backgroundColor = online ? [UIColor systemGreenColor] : [UIColor systemRedColor];
    self.statusDotLabel.text = online ? @"已连接" : @"未连接";
    self.statusDotLabel.textColor = online ? [UIColor systemGreenColor] : [UIColor systemRedColor];
}
...
- (void)viewDidLoad {
    ...
    self.statusDotLabel.textColor = [UIColor systemRedColor];
    ...
    hostNameLb.textColor = UIColor.darkTextColor;
    ...
    dispatch_async(dispatch_get_global_queue(QOS_CLASS_USER_INITIATED, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (d) {
                ...
                [weakSelf render:d];
                weakSelf.upCard.rightLabel.textColor = [UIColor systemGreenColor];
...
- (void)viewDidLoad {
    ...
    secTitle.textColor = [UIColor systemGrayColor];
    ...
    for (int i = 0; i < 5; i++) {
        ...
        lb.textColor = [UIColor systemGrayColor];
    ...
    tip.textColor = [UIColor systemGrayColor];
    tip.numberOfLines = 0;
    ...
    verTitle.textColor = [UIColor systemGrayColor];
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _dlTitle.textColor = [UIColor systemGrayColor];
        ...
        _dlLabel.textColor = [UIColor systemBlueColor];
        ...
        _ulTitle.textColor = [UIColor systemGrayColor];
        ...
        _ulLabel.textColor = [UIColor systemGreenColor];
...
- (UIColor *)tempColor:(NSNumber *)temp {
    double t = temp ? temp.doubleValue : 0;
    if (t > 75) return [UIColor systemRedColor];
    if (t >= 65) return [UIColor systemOrangeColor];
    return [UIColor systemGreenColor];
}
...
- (void)viewDidLoad {
    ...
    self.devCountLabel.textColor = [UIColor systemBlueColor];
    ...
    devSub.textColor = [UIColor systemGrayColor];
    ...
    [smartNameBtn setTitleColor:[UIColor systemBlueColor] forState:UIControlStateNormal];
    smartNameBtn.layer.cornerRadius = 8;
    smartNameBtn.layer.borderWidth = 1;
    smartNameBtn.layer.borderColor = [UIColor systemBlueColor].CGColor;
...
- (void)viewDidLoad {
    ...
    d1.textColor = UIColor.systemGrayColor;
    d1.frame = CGRectMake(14, 10, w - 28, 18);
    [card1 addSubview:d1];
    UIButton *b1 = [self makeBtn:@"开始体检" color:[UIColor systemBlueColor]
    ...
    self.healthResultLabel.textColor = UIColor.darkTextColor;
    ...
    self.healthProgress.textColor = UIColor.systemGrayColor;
    ...
    self.healthBar.progressTintColor = [UIColor systemBlueColor];
    ...
    dSpeed.textColor = UIColor.systemGrayColor;
    ...
    self.speedProgress.textColor = UIColor.systemGrayColor;
    ...
    self.speedLabel.textColor = UIColor.darkTextColor;
    ...
    d3.textColor = UIColor.systemGrayColor;
    ...
    note3.textColor = UIColor.systemGrayColor;
...
- (void)notifySwitchChanged:(UISwitch *)sw {
    ...
    vc.onConfirm = ^{
        ...
        weakSelf.statusLabel.textColor = toOn ? [UIColor systemGreenColor] : UIColor.systemGrayColor;
    };
    vc.modalPresentationStyle = UIModalPresentationOverFullScreen;
    [self presentViewController:vc animated:NO completion:nil];
